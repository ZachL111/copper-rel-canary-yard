"""Regression checks for the copper-rel-canary-yard casebook."""
...
from casebook.harness import assert_expected, copper_rel_canary_yard_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(copper_rel_canary_yard_summary(), assert_expected())
